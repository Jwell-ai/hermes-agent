...
- Use an exact fixed 1920x1080 logical game window/stage. The page may scale that exact stage to fit the actual browser/iframe viewport, but must not create a larger scrollable page.
- Use a single visible stage/root container with CSS like: html/body width:100%, height:100%, margin:0, overflow:hidden; * box-sizing:border-box; body display:grid/place-items:center; stage width:1920px, height:1080px, overflow:hidden, transform-origin:top left.
