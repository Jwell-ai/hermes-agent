...
- Prefer a fixed 1920x1080 logical game window/stage that scales to smaller browser/iframe viewports, but do not reject a complete playable game solely because it uses another bounded layout from the gaming skill.
...
- Use global box-sizing:border-box where practical and avoid negative offsets, fixed-position overlays, or transforms that push UI outside the game frame.
